...
.pull-left[
Suppose we'd like to do some cleaning to each CHAS table in the same manner. Let's create a function that when called, does the following: 
